...
export const Bio = ({bio}) => {
    ...
    <div className='m-16 p-4 md:p-16 w-4/5 mx-auto shadow-lg border border-gray-50'>
        <div className='grid lg:grid-cols-2'>
            ...
            <div className=' max-w-sm md:max-w-md md:mx-16'>
                <h1 className='text-xl md:text-3xl text-left font-semibold'>About me:</h1>
                <p className='text-justify text-sm md:text-md font-light pt-2'>My name is Mateusz Pietryka, I am 29 years old and I am a soon to be a 3rd year Computer Science Student. 
                I am very interested in Front-end Design and Development. 
                </p>
                <p className='text-justify text-sm md:text-md font-light pt-2'>I have discovered my passion for programming not long before Covid-19 pandemic and
                ...
                <p className='text-justify text-sm md:text-md font-light pt-2'>As the time passes, I feel like I have made the best decision of my life, studying Computer Science 
