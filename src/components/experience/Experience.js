        ...
        <div className='flex justify-center'>
            <ul>
                <li>
                    ...
                    I have achieved that using Tailwind CSS and Tailwind Elements. Working on this project taught me how to develop the sites that translate well between different screen 
                    sizes and the importance of it.</span>
                </li>
